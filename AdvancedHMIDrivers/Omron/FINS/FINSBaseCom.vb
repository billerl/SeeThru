...
#Region "Public Methods"
        ...
        '******************************
        Public Function ReadClock() As Date ' String()
            Dim CurrentTNS As Byte
            '* Save this 
            CurrentTNS = CByte(GetNextTransactionID(255))
            ...
            Dim x = Requests(index).Response.RawData
            If Signalled Then
                Dim result As New Date(Requests(index).Response.RawData(14) + 2000, Math.Min(12, Requests(index).Response.RawData(15)), Math.Min(31, Requests(index).Response.RawData(16)),
                                Math.Min(23, Requests(index).Response.RawData(17)), Math.Min(59, Requests(index).Response.RawData(18)), Math.Min(59, Requests(index).Response.RawData(19)))
