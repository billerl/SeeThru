    ...
    Protected Overrides Sub OnCreateControl()
        ...
        If Me.DesignMode Then
            ...
            While MyBase.ImageList Is Nothing And i < j
                If Me.Site.Container.Components(i).GetType.ToString = "System.Windows.Forms.ImageList" Then MyBase.ImageList = Me.Site.Container.Components(i)
                i += 1
            End While
            ...
            If MyBase.ImageList Is Nothing Then
                Me.Site.Container.Add(New System.Windows.Forms.ImageList)
                MyBase.ImageList = Me.Parent.Site.Container.Components(Me.Site.Container.Components.Count - 1)
                'MyBase.ImageIndex = 0
