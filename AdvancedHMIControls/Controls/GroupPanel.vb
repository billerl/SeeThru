...
#Region "PLC Related Properties"
    ...
    Private m_PLCAddressSelectBackColor3 As String = ""
    <System.ComponentModel.Category("PLC Properties")>
    <System.ComponentModel.DefaultValue("")>
    Public Property PLCAddressSelectBackColor3() As String
        Get
            Return m_PLCAddressSelectBackColor3
        End Get
        Set(ByVal value As String)
            If m_PLCAddressSelectBackColor3 <> value Then
                m_PLCAddressSelectBackColor3 = value
...
#Region "Subscribing and PLC data receiving"
    ...
    Private Sub SubscribeToComDriver()
        '* V3.99y - Would not subscribe if started out not visible because the handle would not create
        If Not DesignMode Then ' And IsHandleCreated Then
