        ...
        Set(ByVal value As String)
            If value <> m_Value Then
                If Not String.IsNullOrEmpty(value) Then
                    m_Value = value
                    '* V3.99y
                    Double.TryParse(value, Globalization.NumberStyles.AllowDecimalPoint Or Globalization.NumberStyles.AllowLeadingSign Or Globalization.NumberStyles.AllowParentheses Or Globalization.NumberStyles.AllowTrailingWhite,
    ...
    Private Sub UpdateText()
        ...
        If m_ShowValue Then
            ...
            If Not String.IsNullOrEmpty(m_NumericFormat) Then
                If Double.TryParse(Value, Globalization.NumberStyles.AllowDecimalPoint Or Globalization.NumberStyles.AllowLeadingSign Or Globalization.NumberStyles.AllowParentheses Or Globalization.NumberStyles.AllowTrailingWhite,
