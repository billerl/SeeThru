...
#Region "PLC Related Properties"
    ...
    '* Property - Address in PLC to Link to
    '*****************************************
    Private m_PLCAddressLightBlueValue As String = ""
    <System.ComponentModel.Category("PLC Properties")>
    Public Property PLCAddressLightBlueValue() As String
        Get
            Return m_PLCAddressLightBlueValue
        End Get
        Set(ByVal value As String)
            If m_PLCAddressLightBlueValue <> value Then
                m_PLCAddressLightBlueValue = value
