...
#Region "PLC Related Properties"
    ...
    '* Property - Address in PLC to Link to
    '*****************************************
    Private m_PLCAddressForecolorHighLimitValue As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
    <System.ComponentModel.Category("PLC Properties")>
    Public Property PLCAddressForecolorHighLimitValue() As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
        Get
            Return m_PLCAddressForecolorHighLimitValue
        End Get
        Set(ByVal value As MfgControl.AdvancedHMI.Drivers.PLCAddressItem)
            If m_PLCAddressForecolorHighLimitValue IsNot value Then
    ...
    Private m_PLCAddressForecolorLowLimitValue As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
    <System.ComponentModel.Category("PLC Properties")>
    Public Property PLCAddressForecolorLowLimitValue() As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
        Get
            Return m_PLCAddressForecolorLowLimitValue
        End Get
        Set(ByVal value As MfgControl.AdvancedHMI.Drivers.PLCAddressItem)
            If m_PLCAddressForecolorLowLimitValue IsNot value Then
